	...
	<div class="flex justify-center">
		<ul class="-mb-px flex flex-wrap">
			<li class="me-2 text-xl">
				<a href="#cards" onclick={() => (selectedTab = 'Cards')} class="inline-block rounded-t-lg border-b-2 p-4 {selectedTab === 'Cards' ? 'border-sky-500 text-sky-500' : 'border-transparent hover:border-gray-300 hover:text-gray-300'} ">Cards</a>
			</li>
			<li class="me-2 text-xl">
				<a href="#calendar" onclick={() => (selectedTab = 'Calendar')} class="inline-block rounded-t-lg border-b-2 p-4 {selectedTab === 'Calendar' ? 'border-sky-500 text-sky-500' : 'border-transparent hover:border-gray-300 hover:text-gray-300'}"
					>Calendar</a
				>
			</li>
		</ul>
